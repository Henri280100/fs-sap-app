...
annotate service.RootEntities with @(
    UI.LineItem                : [
        ...
        {
            $Type : 'UI.DataFieldForAction',
            Action: 'service1.EntityContainer/criticalAction',
            //Unbound actions need to be referenced through the entity container (Action import)
            Label : '{i18n>criticalAction}',
        },
        {
            $Type : 'UI.DataFieldForAction',
            Action: 'service1.resetEntities(service1.RootEntities)',
            //Static action
...
annotate service.RootEntities with @(UI.HeaderInfo: {
...
annotate service.RootEntities with @(UI.HeaderFacets: [
    {
...
annotate service.RootEntities with @(UI.Facets: [
    {
        $Type : 'UI.CollectionFacet',
...
annotate service.RootEntities with @(UI.SelectionPresentationVariant #SelectionPresentationVariant: {
